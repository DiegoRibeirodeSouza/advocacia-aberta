...
| `BASE-048` | A exportação oficial do STF traz os Temas de repercussão geral 1474, 1476 e 1477 ("Em julgamento") com o campo de título **vazio na própria fonte** (conferido no bruto da execução `2026-08-21-completa`), e a validação recusa o conjunto inteiro por campo obrigatório vazio. Com isso a recoleta de 21/08/2026 não pôde promover `temas_rg_stf`: o publicado ficou em 1.470 temas e a fonte está em 1.477 — 7 temas novos (1471–1477) e 10 atualizações de temas existentes (912, 1308, 1370, 1412, 1455, 1460, 1465, 1466, 1469, 1470) represados | Decidir e versionar o tratamento de tema recém-reconhecido ainda sem título na exportação: aceitar com a lacuna declarada na saída, derivar identificação provisória do leading case, ou excluir declaradamente até a fonte preencher. A validação passa a distinguir lacuna da própria fonte de falha de extração, e o conjunto volta a ser promovível sem afrouxar a regra para os demais campos | **aberto em 2026-08-21** · na recoleta de 31/08/2026 a exportação veio com todos os títulos preenchidos: o represamento se desfez e o conjunto foi promovido (1.479 temas, incluindo 1471–1479). O tratamento estrutural para a próxima lacuna da fonte segue pendente · **recorreu em 2026-09-14**: a exportação trouxe o Tema 1482 (ARE 1570444, "Em julgamento", repercussão "Não há (questão infraconstitucional)") com título e descrição vazios na fonte; a recoleta completa não pôde promover `temas_rg_stf` e represou os Temas 1480 e 1481 (completos na fonte) e 8 atualizações (843, 1258, 1309, 1457, 1459, 1469, 1478, 1479). Sem o tratamento estrutural, cada tema recém-reconhecido sem título repete o bloqueio · **concluído em 2026-09-14**: o adaptador passa a deixar fora da coleção o tema cujo título vem vazio na exportação e o declara em `_meta.excluidosPorLacunaDaFonte` (número, leading case, situação, motivo e link oficial); a validação segue exigindo título para o que entra; o monitor desconta os omitidos no total e sinaliza quando a fonte preenche o título; a `cobertura_da_base` lista os omitidos. Promovido com 1.481 temas e o 1482 declarado. Pendente de menor porte: a resposta vazia de `buscar_tema_rg` para um número omitido ainda não aponta para a página oficial do tema (só a cobertura o faz) |
...
| `BASE-049` | A compilação oficial do CPC no Planalto aplica a Lei 15.484/2026 no lugar errado: o § 2º novo ("A petição de agravo será dirigida ao presidente ou ao vice-presidente do tribunal de origem […] regime de repercussão geral, de relevância da questão de direito federal infraconstitucional e de recursos repetitivos") aparece como **§ 2º do art. 1.041**, e o **§ 2º do art. 1.042** permanece com a redação da Lei 13.256/2016. O texto da própria Lei 15.484/2026 (https://www.planalto.gov.br/ccivil_03/_ato2023-2026/2026/lei/L15484.htm, conferido em 2026-09-14) altera o art. 1.042, § 2º, e nada diz sobre o art. 1.041, § 2º (que perde a redação anterior na compilação). O snapshot promovido em 2026-09-14 espelha a compilação oficial como está, então quem consultar o art. 1.041, § 2º, ou o art. 1.042, § 2º, no motor recebe texto que diverge da lei | Declarar a divergência na saída dos dois dispositivos (aviso com link para a lei alteradora) enquanto o Planalto não corrigir a compilação; monitorar a página e, quando corrigida, promover e retirar o aviso. Não editar o JSON à mão: a base espelha a fonte e a correção precisa vir dela | **aberto em 2026-09-14** |
